...
/**
 * Write a description of class Pesawa2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Pesawa2 extends Actor
{
    /**
     * Act - do whatever the Pesawa2 wants to do. This method is called whenever
    ...
    public void MakanApel(){
        Actor apel = getOneObjectAtOffset(0,0, pesawa1.class);
        if(apel != null){
